...
const Settings = () => {
  ...
  const renderOption = (iconName, title, navigateTo) => (
    <TouchableOpacity style={styles.option} onPress={() => navigation.navigate(navigateTo)}>
  ...
  return (
    ...
    return (
        ...
        <TouchableOpacity onPress={() => console.log('Section title pressed')}>
          <Text style={styles.sectionTitle}>How you use the app</Text>
        </TouchableOpacity>
